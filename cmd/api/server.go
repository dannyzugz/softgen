...
func main() {
	...
	r.Post("/generator/create/go/chi/{name}", CreateChiProject)
	r.Post("/generator/create/go/gin/{name}", CreateGinProject)
	r.Post("/generator/create/go/gorilla/{name}", CreateMuxProject)
